...
export default function Of() {
  const [text, setText] = useState("Merci pour le follow !");
  ...
  const [soundUrl, setSoundUrl] = useState("/sounds/follow.mp3");
  ...
  return (
    <div className="text-white p-6">
      <h1 className="text-3xl font-bold mb-6">🎉 Overlay Follow - Personnalisation</h1>
