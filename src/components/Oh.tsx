...
export default function Oh() {
  const [text, setText] = useState("Merci pour le host !");
  ...
  const [soundUrl, setSoundUrl] = useState("/sounds/host.mp3");
  ...
  return (
    <div className="text-white p-6">
      <h1 className="text-3xl font-bold mb-6">🎉 Overlay host - Personnalisation</h1>
