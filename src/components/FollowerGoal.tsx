...
type ThemeType =
  ...
  export default function FollowersGoal() {
    const [goal, setGoal] = useState(200);
    const [current, setCurrent] = useState(123);
    const [label, setLabel] = useState("Objectif de Followerss");
  ...
  return (
    <div className="text-white">
      <h1 className="text-3xl font-bold mb-6 animate-fade-in-up"> Followers Goal</h1>
